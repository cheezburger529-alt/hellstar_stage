        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1 mt-0.5 text-[10px] text-muted-foreground">
            <span className="flex items-center gap-0.5">
              {user.micOn ? <MicOff className="w-3 h-3 opacity-0" /> : <MicOff className="w-3 h-3 text-red-400" />}
              <span>{user.micOn ? 'Mic on' : 'Mic off'}</span>
            </span>
            <span className="flex items-center gap-0.5">
              {user.cameraOn ? <VideoOff className="w-3 h-3 opacity-0" /> : <VideoOff className="w-3 h-3 text-red-400" />}
              <span>{user.cameraOn ? 'Cam on' : 'Cam off'}</span>
            </span>
          </div>
        </div>
      </div>
